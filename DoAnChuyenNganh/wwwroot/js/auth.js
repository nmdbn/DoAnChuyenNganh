...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const passwordInputs = document.querySelectorAll('input[type="password"][data-check-strength]');
...
function checkPasswordStrength(e) {
    ...
    const strengthContainer = e.target.parentElement.querySelector('.password-strength');
    
    if (!strengthContainer) return;

    const strengthBar = strengthContainer.querySelector('.password-strength-bar');
    const strengthText = e.target.parentElement.querySelector('.password-strength-text');
...
function validateForm(form) {
    ...
    const confirmPasswordFields = form.querySelectorAll('input[data-confirm-password]');
    confirmPasswordFields.forEach(confirmField => {
        const passwordField = form.querySelector(confirmField.dataset.confirmPassword);
