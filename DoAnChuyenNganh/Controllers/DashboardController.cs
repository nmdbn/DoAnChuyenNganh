...
namespace DoAnChuyenNganh.Controllers
{
    public class DashboardController : Controller
    {
        ...
        // CHỈ ADMIN MỚI XEM ĐƯỢC TRANG THỐNG KÊ
        public IActionResult _Statistical()
        {
            ...
            {
                TempData["ErrorMessage"] = "You do not have permission to access the dashboard.";
            ...
            // View: Views/Dashboard/_Statistical.cshtml
            return View("_Statistical", vm);
        }
    }
}
